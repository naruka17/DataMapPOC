=== FILE: sql/staging/tables/STG_ATM_DEVICE.sql ===

CREATE TABLE fraud_staging.STG_ATM_DEVICE (
    TxnId NVARCHAR(50),
...
-- Simple rule to tag device anomalies at ATM terminals.
UPDATE fraud_staging.STG_ATM_DEVICE
SET FraudFlagRaw = 'Y'
